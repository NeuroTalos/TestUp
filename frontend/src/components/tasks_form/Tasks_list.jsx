    ...
    <div className="w-screen min-h-screen p-8 flex flex-col" style={{ backgroundColor: '#002040' }}>
      ...
      <Tabs
        ...
        items={[
          ...
          {
            label: <span className="text-white text-lg">Нерешённые задания</span>,
            key: 'unsolved',
            children: <UnsolvedTasksListWidget />,
          },
          {
            label: <span className="text-white text-lg">Решённые задания</span>,
            key: 'solved',
