            ...
            <div className="max-w-3xl mx-auto bg-gray-700 p-6 rounded-xl shadow-xl w-full flex flex-col space-y-6">
                ...
                {solution.solution_description && (
                    <div>
                        ...
                        <p className="text-gray-200 whitespace-pre-line border-t border-gray-600">{solution.solution_description}</p>
                    </div>
                )}
                                ...
                                {parsedFiles.map((file, i) => (
                                    <li key={i} className="flex flex-wrap sm:flex-nowrap justify-between items-center text-white gap-2">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="truncate max-w-[70vw] sm:max-w-[400px]">{file.filename}</span>
                                        </div>
                                        <button
                ...
                <div>
                    ...
                    {solution.employer_comment ? (
                        <p className="text-gray-300 whitespace-pre-line border-t border-gray-600">{solution.employer_comment}</p>
                    ) : (
